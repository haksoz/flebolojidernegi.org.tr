...
if($_POST['adi'] && $_GET['islem']=="")
{
	...
	$hedef ="../slider/images/".$yeni_isim;
	
	if($dosya=="" || $adi=="" || $aciklama==""  ){ 
...
$gitti=move_uploaded_file($kaynak,$hedef);
	...
	$haber_ekle_sorgu= $bag ->query("insert into aksesuar ( 
														   adi, 
														   sira,
														   aciklama,
														   resim,
...
if($dosya=="" )
	{
		$haber_duzenle_sorgu= $bag ->query("update aksesuar set adi='$adi', sira='$sira',  aciklama='$aciklama' where id='$duzenlenecek_id'");
	}
	else
	{	
		$resim_bul=mysqli_fetch_array( $bag ->query("select * from aksesuar where id='$duzenlenecek_id'"));
		
	
		$haber_duzenle_sorgu= $bag ->query("update aksesuar set adi='$adi', sira='$sira', aciklama='$aciklama', resim='$yeni_isim' where id='$duzenlenecek_id'");
...
if($_GET['islem']=="duzenle")
{
	...
	$haber_dizi=mysqli_fetch_array( $bag ->query("select * from aksesuar where id = '$id'"));
				...
				<div id="page" class="dashboard">
                	...
                	<div class="widget box light-grey">
                     ...
                     <div class="widget-title">
                        ...
                        <h4><i class="icon-cloud"></i> Aksesuar Ekleme / Güncelleme</h4>
                    ...
                    <?=$bilgi?>
                        ...
                        <form action="#" id="form_sample_1" class="form-horizontal" method="post" enctype="multipart/form-data">
                           ...
                           <div class="control-group">
                              <label class="control-label">Aksesuar Adı</label>
                              <div class="controls">
                         ...
                         <div class="control-group">
                              <label class="control-label">Aksesuar Sırası</label>
                              <div class="controls">
                            ...
                            <div class="control-group">
                              <label class="control-label">Aksesuar Açıklama</label>
                              <div class="controls">
