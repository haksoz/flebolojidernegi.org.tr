...
if($_GET['islem']=="ekle")
{
	...
	$bilgi = "<div class='alert'> <font color='red'>Hata! <Dosya Boş Geçilemez.</font></div>";
	...
	$dosya_ekle_sorgu = $bag -> query("insert into dokumanlar (dokuman_adi, dokuman) values ('$dosya_adi', '$yeni_isim')");
				...
				<div id="page" class="dashboard">
                	...
                	<div class="widget box light-grey">
                     ...
                     <div class="widget-title">
                        ...
                        <h4><i class="icon-camera"></i> Dosya Ekleme </h4>
                    ...
                    <?=$bilgi?>
                        ...
                        <!-- BEGIN FORM-->
                        <form action="dosya_ekle.php?islem=ekle" id="form_sample_1" class="form-horizontal" method="post" enctype="multipart/form-data">
                        	<div class="control-group">
                              <label class="control-label">Dosya Adı<span class="required"> *</span></label>
                              <div class="controls">
