...
{
	$duyuru_baslik = $_POST['name'];
	$duyuru_kisa_baslik = $_POST['kisa_baslik'];
	$duyuru_icerik = $_POST['icerik'];
	$duyuru_sira = $_POST['sira']; 
	$duyuru_sess = $_POST['sess'];
	...
	$hedef  = "images/duyurular/".$yeni_isim;
	...
	$duyuru_ekle_sorgu = $bag -> query("insert into duyurular (baslik, kisa_baslik, icerik, sira, sess, resim) values ('$duyuru_baslik', '$duyuru_kisa_baslik', '$duyuru_icerik', '$duyuru_sira', '$duyuru_sess', '$yeni_isim')");
...
if($_POST['name'] && $_GET['islem']=="duzenle")
{
  ...
  if($dosya!="")
  {
    $resim_bul=mysqli_fetch_array($bag -> query("select * from duyurular where id='$duzenlenecek_id'"));
    $resim_sil=unlink("images/duyurular/".$resim_bul['resim']);
  
    $duyuru_duzenle_sorgu = $bag -> query("update duyurular set baslik='$duyuru_baslik', kisa_baslik='$duyuru_kisa_baslik', icerik='$duyuru_icerik', sira='$duyuru_sira', sess='$duyuru_sess', resim='$yeni_isim' where id='$duzenlenecek_id'");
  ...
  { 
    ...
    $duyuru_duzenle_sorgu = $bag -> query("update duyurular set baslik='$duyuru_baslik', kisa_baslik='$duyuru_kisa_baslik', icerik='$duyuru_icerik', sira='$duyuru_sira', sess='$duyuru_sess' where id='$duzenlenecek_id'");
  }
...
if($_GET['islem']=="sil")
{
  ...
  $duyuru_duzenle_sorgu = $bag -> query("update duyurular set resim='$yeni_isim' where id='$duzenlenecek_id'");
...
if($_GET['islem']=="duzenle" || $_GET['islem']=="sil")
{
	...
	$test = $bag -> query("select * from duyurular where id = '$duyuru_id'");

	$duyuru_dizi = mysqli_fetch_array($test);
				...
				<div id="page" class="dashboard">
                	...
                	<div class="widget box light-grey">
                     ...
                     <div class="widget-title">
                        ...
                        <h4><i class="icon-user"></i> Duyurular Sayfa Ekle / Güncelle</h4>
                    ...
                    <?php echo  $bilgi; ?>
                        ...
                        <form action="#" id="form_sample_1" class="form-horizontal" method="post" enctype="multipart/form-data">
                            <div class="control-group">
                              ...
                              <div class="controls">
                                 <input type="text" name="name" data-required="1" class="span6 " value="<?=$duyuru_dizi['baslik']?>"/>
                              </div>
                           </div>
                           <div class="control-group">
                              <label class="control-label">Alt Menü Başlığı<span class="required"> *</span></label>
                              <div class="controls">
                                 <input type="text" name="kisa_baslik" data-required="1" class="span6 " value="<?=$duyuru_dizi['kisa_baslik']?>"/>
                              </div>
                           </div>
                           <div class="control-group">
                              <div class="controls">
                                <?php
                                   ...
                                   {
                                   ?>
                                   <a href="images/duyurular/<?=$duyuru_dizi['resim']?>" target="_blank">
                                    <img src="images/duyurular/<?=$duyuru_dizi['resim']?>" style="height: 60px;">
                                   </a>
                                  <?php
                                     }
                                     ?>
                           ...
                           <div class="control-group">
                                 ...
                                 <div class="controls">
                                      ...
                                      <?php
                  									  ...
                  									  {
                  									 ?>
                                     <input type="radio" class="toggle" name="sess" <?php if($duyuru_dizi['sess']=='0') {?>checked="checked" <?php } ?> value="0" /> Aktif 
                                     <input type="radio" class="toggle" name="sess" <?php if($duyuru_dizi['sess']=='1') {?>checked="checked" <?php } ?> value="1" /> Pasif
                                     <?php
                  									  }
                  									  else
                  									  {
                              ...
                              <div class="control-group">
	                              ...
	                              <div class="controls">
	                                 <input name="sira" type="text" class="span6 " value="<?=$duyuru_dizi['sira']?>"/> "0-100" arası bir sayı girin.
	                              </div>
                           		</div>
