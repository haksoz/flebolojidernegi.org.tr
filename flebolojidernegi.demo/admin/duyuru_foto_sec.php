...
if($_GET['islem']=="sil")
{
	...
	$resim_bul=mysqli_fetch_array($bag -> query("select * from fotograf_galeri where id='$id'"));
	$resim_sil=unlink("../images/fotograf_galeri/".$resim_bul['resim']);
	
	$fotograf_sil_sorgu = $bag -> query("delete from fotograf_galeri where id='$id'");
                     ...
                     <div class="widget-body">
                        <div class="clearfix margin-bottom-10">
                           <div class="btn-group">
                              ...
                              <a href="foto_ekle.php" style="color:#FFF;">Fotoğraf Ekle</a> <i class="icon-plus"></i>
                              </div>
                           </div>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_1" style="font-size:12px;">
                           ...
                           <?php
						   $say =0;
						    $kategori_cek = $bag -> query("select * from fotograf_galeri where kategori_id='2' order by id desc");
							while($kategori_dizi=mysqli_fetch_array($kategori_cek))
							{ $say ++
						   ?>
                              ...
                              <tr class="odd gradeX">
                                 ...
                                 <td><?=$say?></td>
								  <td><?=$kategori_dizi['kategori_id']?></td>
                                 <td><?php
                                 ...
                                 <a href="images/fotograf_galeri/<?=$kategori_dizi['resim']?>" target="_blank">
                                 	<img src="images/fotograf_galeri/<?=$kategori_dizi['resim']?>" style="height: 60px;">
                                 </a>
                                 <?php
								 }
								 ?></td>
