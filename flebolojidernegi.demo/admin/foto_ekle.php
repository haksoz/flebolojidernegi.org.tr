...
if($_POST['kategori_id'] && $_GET['islem']=="")
{
	...
	$hedef  = "images/fotograf_galeri/".$yeni_isim;
	...
	$fotograf_ekle_sorgu = $bag -> query("insert into fotograf_galeri ( 
														   			kategori_id, 
														   			resim) 
														   			values (
														   			'$kategori_id',
...
if($_POST['kategori_id'] && $_GET['islem']=="duzenle")
{
	...
	if($dosya!="")
	{
		$resim_bul=mysqli_fetch_array($bag -> query("select * from fotograf_galeri where id='$duzenlenecek_id'"));
		$resim_sil=unlink("images/fotograf_galeri/".$resim_bul['resim']);
	
		$fotograf_duzenle_sorgu=$bag -> query("update fotograf_galeri set   kategori_id='$kategori_id', resim='$yeni_isim' where id='$duzenlenecek_id'");
		
		$gitti=move_uploaded_file($kaynak,$hedef);		
	}
	else
	{	
	$fotograf_duzenle_sorgu=$bag -> query("update fotograf_galeri set kategori_id='$kategori_id',    where id='$duzenlenecek_id'");
	}
...
if($_GET['islem']=="duzenle")
{
	...
	$fotograf_dizi=mysqli_fetch_array($bag -> query("select * from fotograf_galeri where id='$fotograf_id'"));
                    ...
                    <?=$bilgi?>
                        ...
                        <form action="#" id="form_sample_1" class="form-horizontal" method="post" enctype="multipart/form-data">
                           ...
                           <div class="control-group">
                              <div class="controls">
                                 <img src="images/fotograf_galeri/<?=$fotograf_dizi['resim']?>" style="height: 60px;">
                              </div>
                           </div>
                        

                           <div class="control-group">
                              <label class="control-label">Fotoğraf Kategorisi</label>
                              <div class="controls">
                              	<select name="kategori_id">
                              	<?php
                                        $foto_kategori_cek = $bag -> query("select * from foto_kategori where sess='0' AND deleted='0'");
                                        $i= 0;
                                        while($foto_kategori_diz = mysqli_fetch_array($foto_kategori_cek))
                                        {
                                            $i=$i+1;
                                    ?> 
							            <option value="<?=$foto_kategori_diz['id']?>"><?=$foto_kategori_diz['kisa_adi']?></option>
