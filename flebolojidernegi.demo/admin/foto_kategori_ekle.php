...
{
	$foto_kategori_adi = $_POST['name'];
	$foto_kategori_kisa_adi = $_POST['kisa_adi'];
	$foto_kategori_sess = $_POST['sess'];
	
	
	$foto_kategori_ekle_sorgu = $bag -> query("insert into foto_kategori (adi, kisa_adi, sess) values ('$foto_kategori_adi', '$foto_kategori_kisa_adi', '$foto_kategori_sess')");
...
if($_POST['name'] && $_GET['islem']=="duzenle")
{
	...
	$foto_kategori_duzenle_sorgu = $bag -> query("update foto_kategori set adi='$foto_kategori_adi', kisa_adi='$foto_kategori_kisa_adi', sess='$foto_kategori_sess' where id='$duzenlenecek_id'");
	
	$bilgi = '	 <div class="alert alert-success">
										Kategori Başarı ile Güncellenmiştir !
				  </div>' ;
}
...
{
	$foto_kategori_id = $_GET['id'];
	
	$durum = "duzenle" ;
	
	$test = $bag -> query("select * from foto_kategori where id = '$foto_kategori_id'");

	$foto_kategori_dizi = mysqli_fetch_array($test);
				...
				<div id="page" class="dashboard">
                	...
                	<div class="widget box light-grey">
                     ...
                     <div class="widget-title">
                        ...
                        <h4><i class="icon-user"></i> foto_kategori Sayfa Ekle / Güncelle</h4>
                    ...
                    <?php echo  $bilgi; ?>
                        ...
                        <form action="#" id="form_sample_1" class="form-horizontal" method="post" enctype="multipart/form-data">
                            ...
                            <div class="control-group">
                              <label class="control-label">Adi<span class="required">*</span></label>
                              <div class="controls">
                                 <input type="text" name="name" data-required="1" class="span6 " value="<?=$foto_kategori_dizi['adi']?>"/>
                              </div>
                           </div>
                           <div class="control-group">
                              <label class="control-label">Kısa Adi<span class="required">*</span></label>
                              <div class="controls">
                                 <input type="text" name="kisa_adi" data-required="1" class="span6 " value="<?=$foto_kategori_dizi['kisa_adi']?>"/>
                              </div>
                           </div>
                           <div class="control-group">
                                 ...
                                 <div class="controls">
									  ...
									  {
									 ?>
                                     <input type="radio" class="toggle" name="sess" <?php if($foto_kategori_dizi['sess']=='0') {?>checked="checked" <?php } ?> value="0" /> Aktif 
                                     <input type="radio" class="toggle" name="sess" <?php if($foto_kategori_dizi['sess']=='1') {?>checked="checked" <?php } ?> value="1" /> Pasif
                                     <?php
									  }
									  else
									  {
