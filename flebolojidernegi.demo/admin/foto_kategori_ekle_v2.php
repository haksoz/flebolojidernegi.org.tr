...
if($_POST['kategori_sira'] && $_GET['islem']=="")
{
	...
	$hedef  = "../images/fotograf_kategori/".$yeni_isim;
	...
	$kategori_ekle_sorgu= $bag -> query("insert into fotograf_galeri_kategori (sira, 
														   kategori_adi, 
														   kategori_resim,
														   durum) 
...
if($_POST['kategori_sira'] && $_GET['islem']=="duzenle")
{
	...
	if($dosya!="")
	{
		$resim_bul=mysqli_fetch_array( $bag -> query("select * from fotograf_galeri_kategori where id='$duzenlenecek_id'"));
		$resim_sil=unlink("../images/fotograf_kategori/".$resim_bul['kategori_resim']);
	
		$yonetici_duzenle_sorgu= $bag -> query("update fotograf_galeri_kategori set durum='$durum', sira='$kategori_sira', kategori_adi='$kategori_adi', kategori_resim='$yeni_isim' where id='$duzenlenecek_id'");
		
		$gitti=move_uploaded_file($kaynak,$hedef);		
	}
	else
	{	
	$yonetici_duzenle_sorgu= $bag -> query("update fotograf_galeri_kategori set durum='$durum', sira='$kategori_sira', kategori_adi='$kategori_adi' where id='$duzenlenecek_id'");
	}
...
if($_GET['islem']=="duzenle")
{
	...
	$kategori_dizi=mysqli_fetch_array( $bag -> query("select * from fotograf_galeri_kategori where id = '$id'"));
