...
if($_GET['islem']=="sil")
{
	...
	$foto_kategori_sil_sorgu = $bag -> query("update foto_kategori set deleted='1' where id='$foto_kategori_id'");

	
	$bilgi = '	 <div class="alert alert-success">
										Kategori Başarı ile Silinmiştir !
				  </div>' ;
               ...
               <div class="span12">
                  ...
                  <div class="widget box light-grey">
                     <div class="widget-title">
                        <h4><i class="icon-globe"></i> Foto Kategori Listesi</h4>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_1" style="font-size:12px;">
                           <thead>
                              <tr>
                                 ...
                                 <th>Kategori Kısa Adı <i class="icon-angle-down" style="float:right;"></th>
                                 <th>Kategori Adı <i class="icon-angle-down" style="float:right;"></th>
                                 <th class="hidden-480">Kategori<i class="icon-angle-down" style="float:right;"></th>
                           ...
                           <?php
						    $foto_kategori_cek = $bag -> query("select * from foto_kategori where deleted='0' order by id desc");
							$i= 0;
							while($foto_kategori_dizi = mysqli_fetch_array($foto_kategori_cek))
							{
								$i=$i+1;
						   ?>
                              ...
                              <tr class="odd gradeX">
                              	<td><?=$i?></td>
                                 <td><?=$foto_kategori_dizi['kisa_adi']?></td>
                                 <td><?=$foto_kategori_dizi['adi']?></td>
                                 <td> <?php if($foto_kategori_dizi['sess']=="0")
                                             { ?> Aktif 
                                             <?php 
                                             } 
                                             else
                                 ...
                                 <td >
	                                 <a href="?islem=sil&id=<?=$foto_kategori_dizi['id']?>" title="Sil" onclick="return confirm('Silmek istediğinize emin misiniz ?')">
	                                 <i class="icon-remove sercan_sil_icon"></i>
	                                 </a>
	                                 
	                                 <a href="foto_kategori_ekle.php?islem=duzenle&id=<?=$foto_kategori_dizi['id']?>" title="Düzenle">
