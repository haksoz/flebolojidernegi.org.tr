...
if($_GET['islem']=="sil")
{
	...
	$hakkimizda_sil_sorgu = $bag -> query("update hakkimizda set deleted='1' where id='$hakkimizda_id'");
		               ...
		               <div class="span12">
		                  ...
		                  <div class="widget box light-grey">
		                     <div class="widget-title">
		                        <h4><i class="icon-globe"></i> Hakkımızda Sayfa Listesi</h4>
		                     ...
		                     <div class="widget-body">
		                        <div class="clearfix margin-bottom-10">
		                           <div class="btn-group">
		                              ...
		                              <a href="hakkimizda_ekle.php" style="color:#FFF;">Sayfa Ekle</a> <i class="icon-plus"></i>
		                              </div>
		                           </div>
		                        ...
		                        <table class="table table-striped table-bordered table-hover" id="sample_1" style="font-size:12px;">
		                           ...
		                           <?php
								    $hakkimizda_cek = $bag -> query("select * from hakkimizda where deleted='0' order by id desc");
									$i= 0;
									while($hakkimizda_dizi = mysqli_fetch_array($hakkimizda_cek))
									{
										$i=$i+1;
								   ?>
		                           
		                              <tr class="odd gradeX">
		                                 <td><?=$hakkimizda_dizi['sira']?></td>
		                                 <td><?=$hakkimizda_dizi['kisa_baslik']?></td>
		                                 <td><?=$hakkimizda_dizi['baslik']?></td>
		                                 <td><?php if($hakkimizda_dizi['resim']=="no-image")
											 	{
											 	echo "Resim yok";
											 	}
											 	else
			                                 ...
			                                 <a href="images/hakkimizda/<?=$hakkimizda_dizi['resim']?>" target="_blank">
			                                 	<img src="images/hakkimizda/<?=$hakkimizda_dizi['resim']?>" style="height: 40px;">
			                                 </a>
		                                 	<?php
										 	}
										 	?>
										</td>
		                                 <td> <?php if($hakkimizda_dizi['sess']=="0")
		                                             { ?> Aktif 
		                                             <?php 
		                                             } 
		                                             else
		                                 ...
		                                 <td >
			                                 ...
			                                 <a href="hakkimizda_ekle.php?islem=duzenle&id=<?=$hakkimizda_dizi['id']?>" title="Düzenle">
