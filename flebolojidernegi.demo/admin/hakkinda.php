...
if(isset($_POST['hizmet']))
{
	...
	$random = rand(0,9999);
	$yeni_isim = $random."_alt".$dosya;
	$hedef  = "../images/hizmetlerimiz/".$yeni_isim;
	
	if($dosya!="")
	{
		$resim_bul=mysqli_fetch_array($bag -> query("select * from hizmetler where id=1"));
		$resim_sil=unlink("../images/hizmetlerimiz/".$resim_bul['resim']);
	
		$fotograf_duzenle_sorgu = $bag -> query("update hizmetler set   hizmet='$hizmet', resim='$yeni_isim' where id=1");
		
		$gitti=move_uploaded_file($kaynak,$hedef);		
	}
	else
	{	
	$referans_duzenle_sorgu=$bag -> query("update hakkinda set aciklama='$hizmet' where id='1'");
	}
...
$resim_bul=mysqli_fetch_array($bag -> query("select * from hakkinda where id='1'"));
				...
				<div id="page" class="dashboard">
                	...
                	<div class="widget box light-grey">
                     ...
                     <div class="widget-title">
                        ...
                        <h4><i class="icon-tags"></i> Hizmetler Güncelleme</h4>
                        ...
                        <form action="#" id="form_sample_1" class="form-horizontal" method="post" enctype="multipart/form-data">
                             ...
                             <div class="control-group">
                              ...
                              <div class="controls">
								...
								<textarea class="span12 ckeditor m-wrap" name="hizmet" rows="6"><?=$resim_bul['aciklama']?></textarea>
