...
if($_GET['islem']=="sil")
{
	...
	$resim_bul=mysql_fetch_array(mysql_query("select * from odemeler where id='$id'"));
	$resim_sil=unlink("../images/animals/".$resim_bul['resim']);
	
	$referanslar_sil_sorgu = mysql_query("delete from odemeler where id='$id'");
               ...
               <div class="span12">
                  ...
                  <div class="widget box light-grey">
                     <div class="widget-title">
                        <h4><i class="icon-tags"></i> Hesap No Listesi</h4>
                     ...
                     <div class="widget-body">
                        <div class="clearfix margin-bottom-10">
                           <div class="btn-group">
                              ...
                              <a href="hesap_ekle.php" style="color:#FFF;"> Hesap No Ekle</a> <i class="icon-plus"></i>
                              </div>
                           </div>
				...
				<th > Sıra <i class="icon-angle-down" style="float:right;"></th>
                                 <th > Banka Adı <i class="icon-angle-down" style="float:right;"></th>
                           ...
                           <?php
						   $say = 0;
						    $referans_cek=mysql_query("select * from odemeler order by sira asc");
				...
				<a href="?islem=sil&id=<?=$referans_dizi['id']?>" title="Sil" onclick="return confirm('Silmek istediğinize emin misiniz ?')">
                                 ...
                                 <a href="hesap_ekle.php?islem=duzenle&id=<?=$referans_dizi['id']?>" title="Düzenle">
