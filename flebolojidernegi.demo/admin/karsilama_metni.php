...
if(isset($_POST['baslik']))
{
	$baslik = $_POST['baslik'];
	$metin = $_POST['metin'];
	$alt_metin = $_POST['alt_metin'];
	$sess = $_POST['sess'];
	
	
	$karsilama_duzenle_sorgu = $bag -> query("update karsilama set baslik='$baslik',
									metin='$metin', 
									alt_metin='$alt_metin', 
									sess='$sess'							
									where id='1'");
                    ...
                    <?=$bilgi?>
                        ...
                        <form action="#" id="form_sample_1" class="form-horizontal" method="post" enctype="multipart/form-data">
                            <div class="control-group">
                              <label class="control-label">Başlık<span class="required">*</span></label>
                              <div class="controls">
                                 <input type="text" name="baslik" data-required="1" class="span6 " value="<?=$karsilama_dizi['baslik']?>"/>
                              </div>
                           </div>
                           ...
                           <div class="control-group">
                              ...
                              <div class="controls">
								...
								<textarea class="span12 ckeditor m-wrap" name="metin" rows="6">
                           ...
                           <div class="control-group">
                              <label class="control-label">Alt Metin<span class="required">*</span></label>
                              <div class="controls">
                                 <input type="text" name="alt_metin" data-required="1" class="span6 " value="<?=$karsilama_dizi['alt_metin']?>"/>
                              </div>
                           </div>
                           
                           
                           <div class="control-group">
                                 <label class="control-label">Anasayfada</label>
                                 <div class="controls">
                                  
                             
                                     <input type="radio" class="toggle" name="sess" <?php if($karsilama_dizi['sess']=='0') {?>checked="checked" <?php } ?> value="0" /> Gösterilsin 
                                     <input type="radio" class="toggle" name="sess" <?php if($karsilama_dizi['sess']=='1') {?>checked="checked" <?php } ?> value="1" /> Gösterilmesin
