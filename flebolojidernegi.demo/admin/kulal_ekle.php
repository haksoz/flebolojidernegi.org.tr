...
$gitti=move_uploaded_file($kaynak,$hedef);
	...
	$haber_ekle_sorgu=mysql_query("insert into urunler (
														   adi, 
														   sira,
														   aciklama,
														   resim,
...
if($dosya=="" ||  $aciklama=="" || $adi==""  )
	{
		$haber_duzenle_sorgu=mysql_query("update urunler set adi='$adi', sira='$sira', aciklama='$aciklama' where id='$duzenlenecek_id'");
	}
	else
	{	
		...
		$haber_duzenle_sorgu=mysql_query("update urunler set adi='$adi', sira='$sira',  aciklama='$aciklama', resim='$yeni_isim' where id='$duzenlenecek_id'");
...
if($_GET['islem']=="duzenle")
{
	...
	$haber_dizi=mysql_fetch_array(mysql_query("select * from urunler where id = '$id'"));
				...
				<div id="page" class="dashboard">
                	...
                	<div class="widget box light-grey">
                     ...
                     <div class="widget-title">
                        ...
                        <h4><i class="icon-cloud"></i> Kullanım Alanı Ekleme / Güncelleme</h4>
                    ...
                    <?=$bilgi?>
                        ...
                        <form action="#" id="form_sample_1" class="form-horizontal" method="post" enctype="multipart/form-data">
                           ...
                           <div class="control-group">
                              <label class="control-label">Kullanım Alanı Adı</label>
                              <div class="controls">
                         ...
                         <div class="control-group">
                              <label class="control-label">Kullanım Alanı Sırası</label>
                              <div class="controls">
                            ...
                            <div class="control-group">
                              <label class="control-label">Kullanım Alanı Açıklama</label>
                              <div class="controls">
