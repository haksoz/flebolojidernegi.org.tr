...
if($_GET['islem']=="sil")
{
	...
	$resim_sil=unlink("../images/animals/".$resim_bul['resim']);
	
	$referanslar_sil_sorgu = mysql_query("delete from urunler where id='$id'");
               ...
               <div class="span12">
                  ...
                  <div class="widget box light-grey">
                     <div class="widget-title">
                        <h4><i class="icon-tags"></i> Kullanım Alanları Listesi</h4>
                     ...
                     <div class="widget-body">
                        <div class="clearfix margin-bottom-10">
                           <div class="btn-group">
                              ...
                              <a href="akses_ekle.php" style="color:#FFF;"> Kullanım Alanı Ekle</a> <i class="icon-plus"></i>
                              </div>
                           </div>
				...
				<th > Sıra <i class="icon-angle-down" style="float:right;"></th>
                                 <th > Kullanım Alan Adı <i class="icon-angle-down" style="float:right;"></th>
                           ...
                           <?php
						   $say = 0;
						    $referans_cek=mysql_query("select * from urunler order by sira asc");
				...
				<td><?=$referans_dizi['adi']?></td>
								 ...
								 {
								 ?>
                                 <a  href="../images/animals/<?=$referans_dizi['resim']?>" target="_blank">Resmi Gör</a>
                                 <?php
								 }
								 ?></td>
				...
				<a href="?islem=sil&id=<?=$referans_dizi['id']?>" title="Sil" onclick="return confirm('Silmek istediğinize emin misiniz ?')">
                                 ...
                                 <a href="kulal_ekle.php?islem=duzenle&id=<?=$referans_dizi['id']?>" title="Düzenle">
