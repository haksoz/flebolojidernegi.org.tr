...
{
	$id = $_GET['id'];
	$bilgi = header("Location: cevapla.php");
               ...
               <div class="span12">
                  ...
                  <div class="widget box light-grey">
                     <div class="widget-title">
                        <h4><i class="icon-bookmark-empty"></i> Mesajlar</h4>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_1" style="font-size:12px;">
                           <thead>
                              <tr>
                                 ...
                                 <th ><center>Gönderen Ad Soyad<i class="icon-angle-down" style="float:right;"></th>
                                 <th><center> Gönderen Mail <i class="icon-angle-down" style="float:right;"></th>
						   ...
						   ?>
                              ...
                              <tr class="odd gradeX">
								 ...
								 {
								 ?>
                                 <font color="blue"><center>Henüz Okunmadı <a href="oku.php?id=<?=$kategori_dizi['id']?>">(Oku)</a></center></font>
                                 <?php
								 }
								 else
								 {
								 ...
								 <a href="?islem=cevap&id=<?=$duyuru_dizi['id']?>" title="Cevapla">
