...
oturumkontrolana();
	...
	$sil_id = $_GET['id'];
	$sil=mysql_query("DELETE FROM `iletisim` WHERE  `id`='$sil_id'");
				...
				<div id="page" class="dashboard">
                	...
                	<div class="widget box light-grey">
                     ...
                     <div class="widget-title">
                        ...
                        <h4><i class="icon-edit"></i> Mesaj Bilgilendirme</h4>
                    ...
                    <div class="widget-body form">
                        ...
                        <!-- BEGIN FORM-->
                            ...
                            <div class="control-group">
							  ...
							  if($sil)
						{
							echo "<b><font color='green'>Mesaj başarıyla silinmiştir.</font> "; 
							header("refresh:2;url=mesajlar.php");
						}else
						{
						
							echo "<b><font color='red'>Mesaj silmede hata oluştu.</font>";
							header("refresh:2;url=mesajlar.php");
						} 
							?></label>
                           </div>
