	...
	if($_GET['islem']=="sil")
{
	...
	$bilgi = header("Location: iletisim.php?islem=sil");
				...
				<div id="page" class="dashboard">
                	...
                	<div class="widget box light-grey">
                     ...
                     <div class="widget-title">
                        ...
                        <h4><i class="icon-edit"></i> İletişim Formu Okuma &nbsp;&nbsp;&nbsp;
                    ...
                    <div class="widget-body form">
                       ...
                       <div class="control-group">
                              <label class="control-label"><b>Adı Soyadı:</b> <?=$sayfa_dizi['ad']?> </label>
                           </div>
						   
                                                                                 
                           <div class="control-group">
                              <label class="control-label"><b>E-Posta: </b><a href="mailto:<?=$sayfa_dizi['mail']?>"><?=$sayfa_dizi['mail']?></a></label>
                              
                           </div>
						   
						   <div class="control-group">
                              <label class="control-label"><b>Telefon:</b> <?=$sayfa_dizi['telefon']?> </label>
                           </div>
						   
                           <div class="control-group">
                              <label class="control-label"><b>Web:</b><a target="_blank"href="<?=$sayfa_dizi['web']?>">  <?=$sayfa_dizi['web']?> </a></label>
                           </div>
                          ...
                          <br />
						   ...
						   <br />
                           <div class="control-group">
                                 <label class="control-label"><b>Konu:</b></label>
                                 <div class="controls">
                                    <?=$sayfa_dizi['konu']?>
                                 </div>
                              </div>
