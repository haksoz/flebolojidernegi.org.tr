...
if(isset($_POST['site_title']))
{
	...
	$ayar_duzenle_sorgu = $bag -> query("update ayar set site_title='$site_title',
									site_meta='$site_meta', 
	...
	$ayar_dizi=mysqli_fetch_array($bag -> query("select * from ayar where ayar_id = '1'"));
                    ...
                    <?=$bilgi?>
                        ...
                        <form action="#" id="form_sample_1" class="form-horizontal" method="post" enctype="multipart/form-data">
                          ...
                          <hr>
                           ...
                           <div class="control-group">
                              <label class="control-label">Firma GSM</label>
                              <div class="controls">
