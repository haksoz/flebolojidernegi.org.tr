...
if($_POST['name'] && $_GET['islem']=="")
{
	...
	$yonetici_ekle_sorgu = $bag -> query("insert into yonetici (yonetici_ad_soyad, 
														   yonetici_kullanici, 
														   yonetici_sifre, 
														   yonetici_email,
														   sess,
...
if($_POST['name'] && $_GET['islem']=="duzenle")
{
	...
	$yonetici_duzenle_sorgu = $bag -> query("update yonetici set yonetici_ad_soyad='$ad_soyad', yonetici_kullanici='$kullanici', yonetici_sifre='$sifre', yonetici_email='$email' where yonetici_id='$duzenlenecek_id'");
...
if($_GET['islem']=="duzenle")
{
	...
	$test = $bag -> query("select * from yonetici where yonetici_id = '$yonetici_idd'");

	$yonetici_dizi = mysqli_fetch_array($test);
