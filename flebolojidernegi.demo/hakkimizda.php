                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-4">
                            ...
                            <h2 class="secondry-heading">Hakkimizda</h2>
                            ...
                            <div class="widget collapse navbar-collapse" id="navbarNav">
                                <ul class="categories-widget">
                                    <?php
                                        $hakkimizda_cek = $bag -> query("select * from hakkimizda where sess='0' AND deleted='0' order by sira");
                                        $i= 0;
                                    ...
                                    ?> 
                                        <li>
                                            <a href="hakkimizda.php?id=<?=$hakkimizda_dizi['id']?>">
                                                <em><?=$hakkimizda_dizi['kisa_baslik']?></em>
                                            </a>
                                        </li>
                                    <?php
                                        }
                        ...
                        <div class="col-md-9 col-sm-8">
                            <?php
                                ...
                                $hakkimizda_bul=mysqli_fetch_array($bag -> query("select * from hakkimizda where id='$hakkimizda_id'"));
                            ?>
                            <div class="content">
                                <div class="primary-heading">
                                    <h2><?=$hakkimizda_bul['baslik']?></h2>
                                </div>
