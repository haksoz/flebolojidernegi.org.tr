                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-4">
                            ...
                            <h2 class="secondry-heading">Onam Formları</h2>
                            ...
                            <div class="widget collapse navbar-collapse" id="navbarNav">
                                <ul class="categories-widget">
                                    <?php
                                        $duyuru_cek = $bag -> query("select * from onam_formlari where sess='0' AND deleted='0' order by sira");
                                        $i= 0;
                                    ...
                                    ?> 
                                        <li>
                                            <a href="onam_formlari.php?id=<?=$duyuru_dizi['id']?>">
                        ...
                        <div class="col-md-9 col-sm-8">
                            <?php
                                $duyuru_id = $_GET['id'];
                                $duyuru_bul=mysqli_fetch_array($bag -> query("select * from onam_formlari where id='$duyuru_id'"));
                            ?>
                            <div class="content">
                                ...
                                <div class="post-widget light-shadow white-bg">
                                    ...
                                    <article class="post">
                                        <div class="post-thumb p-30"> 
                                            <img src="admin\images\onam_formlari\<?=$duyuru_bul['resim']?>" alt="">
                                        </div>
